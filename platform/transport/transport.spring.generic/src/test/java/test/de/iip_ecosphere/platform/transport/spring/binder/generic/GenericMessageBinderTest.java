...
@ContextConfiguration(initializers = GenericMessageBinderTest.Initializer.class)
...
public class GenericMessageBinderTest {
    ...
    public static class Initializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        public void initialize(ConfigurableApplicationContext applicationContext) {
            ...
            TestPropertyValues
                ...
                .applyTo(applicationContext);
            if (null == GenericClient.getLastInstance() && null != getKeystoreKey()) {
                TestPropertyValues
                    .of("generic.keystoreKey=" + getKeystoreKey())
                    .applyTo(applicationContext);
            }
        }
    ...
    public static void init() {
        ...
        try {
            ...
            infra.setReceptionCallback("genericBinder", new ReceptionCallback<String>() {
