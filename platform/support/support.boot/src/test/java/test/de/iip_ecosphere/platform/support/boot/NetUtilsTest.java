...
public class NetUtilsTest {
    ...
    public void testGetOwnIP() {
        ...
        NetUtils.isContainerIp(ip);
        NetUtils.isIpV4Addess(ip);
        NetUtils.getNetMask("255.255.255.0", ip);
        NetUtils.connectionOk("http://localhost");
        NetUtils.getOwnIP(null);
        NetUtils.getOwnIP("");
        NetUtils.getOwnIP("255.255.255.0");
