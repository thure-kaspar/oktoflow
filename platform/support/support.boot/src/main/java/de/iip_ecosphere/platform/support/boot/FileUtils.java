...
package de.iip_ecosphere.platform.support.boot;
...
public class FileUtils {
     ...
     * @param filter the filter to apply, <b>null</b> means copy all directories and files should be the same as 
     *     the original
     ...
     * @param srcDir an existing directory to copy
     * @param destDir the new directory
     * @param filter the filter to apply, <b>null</b> means copy all directories and files
