 ...
 *   <li>Representation instances like {@link de.iip_ecosphere.platform.support.aas.aas.Aas} or 
 *       {@link de.iip_ecosphere.platform.support.aas.aas.Submodel} are instances for wrappers shielding the implementing 
 ...
 *   <li>The {@link de.iip_ecosphere.platform.support.aas.aas.AasFactory} provides top-level access, in particular to the 
 *       {@link de.iip_ecosphere.platform.support.aas.aas.Aas.AasBuilder}. Actual implementations such as for BaSyx are
 *       realized in own projects and hook themselves into via 
 *       {@link de.iip_ecosphere.platform.support.aas.aas.AasFactoryDescriptor} and the Java Service Loader. So far, the
 ...
 * </ul>
 */
package de.iip_ecosphere.platform.support.aas.aas;